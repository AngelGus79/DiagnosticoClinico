...
var _rtfeldman$elm_workshop$Native_RunTest = function()
{
    return {
...
var _rtfeldman$elm_workshop$Test_Reporter_TestResults$TestResult = F3(
	function (a, b, c) {
		return {labels: a, expectations: b, duration: c};
	});
var _rtfeldman$elm_workshop$Test_Reporter_TestResults$Failure = F2(
	function (a, b) {
...
var _rtfeldman$elm_workshop$Test_Reporter_Json$reportSummary = F3(
	function (duration, autoFail, results) {
...
var _rtfeldman$elm_workshop$Test_Reporter_Json$encodeFailure = function (_p1) {
	var _p2 = _p1;
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
...
var _rtfeldman$elm_workshop$Test_Reporter_Json$encodeFailures = function (expectations) {
	return _elm_lang$core$Json_Encode$list(
		A2(
			_elm_lang$core$List$filterMap,
			function (_p3) {
				return A2(
					_elm_lang$core$Maybe$map,
					_rtfeldman$elm_workshop$Test_Reporter_Json$encodeFailure,
					_elm_community$elm_test$Test_Runner$getFailure(_p3));
			},
			expectations));
};
var _rtfeldman$elm_workshop$Test_Reporter_Json$encodeLabels = function (labels) {
	return _elm_lang$core$Json_Encode$list(
		A2(
			_elm_lang$core$List$map,
...
var _rtfeldman$elm_workshop$Test_Reporter_Json$getStatus = function (expectations) {
...
var _rtfeldman$elm_workshop$Test_Reporter_Json$reportComplete = function (_p5) {
	var _p6 = _p5;
		...
		_elm_lang$core$Json_Encode$object(
			{
				...
				_1: {
					...
					_0: {
						...
						_0: 'status',
						_1: _elm_lang$core$Json_Encode$string(
							_rtfeldman$elm_workshop$Test_Reporter_Json$getStatus(_p7))
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'labels',
							_1: _rtfeldman$elm_workshop$Test_Reporter_Json$encodeLabels(_p6.labels)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'failures',
								_1: _rtfeldman$elm_workshop$Test_Reporter_Json$encodeFailures(_p7)
							},
							_1: {
								ctor: '::',
								_0: {
...
var _rtfeldman$elm_workshop$Test_Reporter_Json$reportBegin = function (_p8) {
	var _p9 = _p8;
	return _elm_lang$core$Maybe$Just(
		_elm_lang$core$Json_Encode$object(
			{
...
var _rtfeldman$elm_workshop$Test_Runner_Node$warn = F2(
	function (str, result) {
		var _p0 = _elm_lang$core$Debug$log(str);
		return result;
	});
var _rtfeldman$elm_workshop$Test_Runner_Node$runThunk = _rtfeldman$elm_workshop$Native_RunTest.runThunk;
var _rtfeldman$elm_workshop$Test_Runner_Node$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {available: a, running: b, queue: c, startTime: d, finishTime: e, completed: f, testReporter: g, autoFail: h};
	});
var _rtfeldman$elm_workshop$Test_Runner_Node$Finish = function (a) {
	return {ctor: 'Finish', _0: a};
};
var _rtfeldman$elm_workshop$Test_Runner_Node$Complete = F5(
	function (a, b, c, d, e) {
		return {ctor: 'Complete', _0: a, _1: b, _2: c, _3: d, _4: e};
	});
var _rtfeldman$elm_workshop$Test_Runner_Node$Dispatch = function (a) {
	return {ctor: 'Dispatch', _0: a};
};
var _rtfeldman$elm_workshop$Test_Runner_Node$dispatch = A2(_elm_lang$core$Task$perform, _rtfeldman$elm_workshop$Test_Runner_Node$Dispatch, _elm_lang$core$Time$now);
var _rtfeldman$elm_workshop$Test_Runner_Node$update = F3(
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							...
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_workshop$Test_Runner_Node$dispatch,
								_1: {ctor: '[]'}
							}
						})
				};
			default:
				...
				if (_p6.ctor === '[]') {
					return {
						ctor: '_Tuple2',
						_0: _p9,
						_1: A2(_elm_lang$core$Task$perform, _rtfeldman$elm_workshop$Test_Runner_Node$Finish, _elm_lang$core$Time$now)
					};
				} else {
					var _p8 = _p6._0;
					...
					if (_p7.ctor === 'Nothing') {
						return A2(
							_rtfeldman$elm_workshop$Test_Runner_Node$warn,
							A2(
								_elm_lang$core$Basics_ops['++'],
						...
						var expectations = _rtfeldman$elm_workshop$Test_Runner_Node$runThunk(_p7._0.run);
						var complete = A4(_rtfeldman$elm_workshop$Test_Runner_Node$Complete, _p8, _p7._0.labels, expectations, _p3._0);
						return {
							ctor: '_Tuple2',
							_0: newModel,
...
var _rtfeldman$elm_workshop$Test_Runner_Node$init = F2(
	function (emit, _p11) {
		var _p12 = _p11;
		var testReporter = _rtfeldman$elm_workshop$Test_Reporter_Reporter$createReporter(_p12.report);
		var _p13 = function () {
...
var _rtfeldman$elm_workshop$Test_Runner_Node$runWithOptions = F2(
	function (options, emit) {
		return A2(
			_rtfeldman$elm_workshop$Test_Runner_Node_App$run,
			options,
			{
				init: _rtfeldman$elm_workshop$Test_Runner_Node$init(emit),
				update: _rtfeldman$elm_workshop$Test_Runner_Node$update(emit),
...
var _rtfeldman$elm_workshop$Test_Generated_Main496aafb3c4c5cf7d1e284a81de8ccea9$emit = _elm_lang$core$Native_Platform.outgoingPort(
	'emit',
	function (v) {
		return [v._0, v._1];
	});
var _rtfeldman$elm_workshop$Test_Generated_Main496aafb3c4c5cf7d1e284a81de8ccea9$main = A3(
	_rtfeldman$elm_workshop$Test_Runner_Node$runWithOptions,
	{
	...
	_rtfeldman$elm_workshop$Test_Generated_Main496aafb3c4c5cf7d1e284a81de8ccea9$emit,
	_elm_community$elm_test$Test$concat(
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _rtfeldman$elm_workshop$Tests$all,
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
...
Elm['Test']['Generated']['Main496aafb3c4c5cf7d1e284a81de8ccea9'] = Elm['Test']['Generated']['Main496aafb3c4c5cf7d1e284a81de8ccea9'] || {};
if (typeof _rtfeldman$elm_workshop$Test_Generated_Main496aafb3c4c5cf7d1e284a81de8ccea9$main !== 'undefined') {
    _rtfeldman$elm_workshop$Test_Generated_Main496aafb3c4c5cf7d1e284a81de8ccea9$main(Elm['Test']['Generated']['Main496aafb3c4c5cf7d1e284a81de8ccea9'], 'Test.Generated.Main496aafb3c4c5cf7d1e284a81de8ccea9', undefined);
}
